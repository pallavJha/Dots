...
" Run the following command to install the coc server, more info here https://github.com/neoclide/coc.nvim#quick-start
...
" ****************** Closing the vim script copied from https://github.com/neoclide/coc.nvim#example-vim-configuration
